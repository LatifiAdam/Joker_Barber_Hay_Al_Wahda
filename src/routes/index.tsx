...
import salonAsset from "../assets/joker-salon.jpeg.asset.json";
import productsAsset from "../assets/joker-products.jpeg.asset.json";
import reelAsset from "../assets/joker-barber-reel.mp4.asset.json";
import reelPosterAsset from "../assets/joker-barber-reel-poster.jpg.asset.json";

const salonImage = salonAsset.url;
const productsImage = productsAsset.url;
const reelVideo = reelAsset.url;
const reelPoster = reelPosterAsset.url;
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Joker Barber | Barbier à Hay Al Wahda, Rabat" },
      { name: "description", content: "Joker Barber à Hay Al Wahda, Rabat : coupes, dégradés, barbe et réservation directe sur WhatsApp." },
      { property: "og:title", content: "Joker Barber | Barbier à Rabat" },
      { property: "og:description", content: "Coupes nettes, dégradés précis et réservation directe à Hay Al Wahda, Rabat." },
      ...
      <main id="top">
          ...
          <div className="relative mx-auto grid max-w-6xl items-end gap-10 px-5 pb-14 pt-14 lg:grid-cols-12 lg:pt-20">
            ...
            <div className="reveal delay-2 lg:col-span-5">
              <div className="relative overflow-hidden rounded-xl border border-frost/10 bg-panel">
                <img src={salonImage} alt="Intérieur réel du salon Joker Barber à Hay Al Wahda" width={768} height={1024} fetchPriority="high" className="aspect-[4/5] w-full object-cover" />
        ...
        <section id="gallery" className="mx-auto max-w-6xl scroll-mt-24 px-5 pb-20">
          ...
          <div className="mt-7 grid gap-4 md:grid-cols-12">
            <div className="overflow-hidden rounded-lg border border-line bg-panel md:col-span-8">
              <video
                controls
                playsInline
                preload="metadata"
                ...
                aria-label="Montage vidéo des réalisations et du salon Joker Barber"
              >
                <source src={reelVideo} type="video/mp4" />
              </video>
            </div>
            <a href={instagramUrl} target="_blank" rel="noreferrer" className="group relative overflow-hidden rounded-lg md:col-span-4">
              <img src={productsImage} alt="Produits professionnels disponibles chez Joker Barber" width={768} height={1024} loading="lazy" className="aspect-video h-full w-full object-cover transition-transform duration-700 group-hover:scale-[1.025] md:aspect-auto" />
          ...
          <p className="mt-3 font-mono text-[9px] uppercase text-muted">Musique : Gymnopédie n°1 — Erik Satie · domaine public</p>
          ...
          <div className="mx-auto max-w-6xl scroll-mt-24 px-5 py-20">
            ...
            <div className="mt-7 grid gap-8 lg:grid-cols-12 lg:items-stretch">
              <div className="overflow-hidden rounded-lg lg:col-span-7">
                <img src={productsImage} alt="Sélection réelle de produits et accessoires professionnels chez Joker Barber" width={768} height={1024} loading="lazy" className="h-full min-h-72 w-full object-cover" />
              </div>
